...
public class EmployeeStreamDemo2 {
...
//            method15();
    ...
    public static void method1(){
        System.out.println("how many male and female members ");
        Map<String, Long> num1 =  employeeList.stream().collect(Collectors.groupingBy(Employee::getGender, Collectors.counting()));
